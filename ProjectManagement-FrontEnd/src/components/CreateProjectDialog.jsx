...
//         startDate: formData.start_date || null,
//         endDate: formData.end_date || null,
//         teamMemberIds: formData.team_members.map(mapEmailToUserId).filter(Boolean),
//         teamLeadId: formData.team_lead ? mapEmailToUserId(formData.team_lead) : null,
//       };
...
//             className="w-full px-3 py-2 rounded border mt-1 h-20"
//           />
//         </div>
...
//             <div className="flex flex-wrap gap-2 mt-2">
//               {formData.team_members.map((email) => (
//                 <div key={email} className="flex items-center gap-1 bg-blue-200/50 px-2 py-1 rounded text-sm">
//                   {email}
//                   <button type="button" onClick={() => removeTeamMember(email)} className="ml-1 rounded">
//                     <XIcon className="w-3 h-3" />
//                   </button>
//                 </div>
//               ))}
...
//         {/* Footer */}
//         <div className="flex justify-end gap-3 pt-2 text-sm">
//           <button type="button" onClick={() => setIsDialogOpen(false)} className="px-4 py-2 rounded border">
//             Cancel
//           </button>
//           <button disabled={isSubmitting || !currentWorkspace} className="px-4 py-2 rounded bg-blue-500 text-white">
//             {isSubmitting ? "Creating..." : "Create Project"}
//           </button>
//         </div>
//       </form>
