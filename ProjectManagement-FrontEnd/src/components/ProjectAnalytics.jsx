...
import { getProjectAnalytics } from "../services/Project/ProjectAPI";
...
//     const { TotalTasks, CompletedTasks, ActiveTasks, OverdueTasks, TeamSize, TasksByStatus, TasksByType, TasksByPriority, CompletionRate } = analytics;

//     // Memoize data for charts
//     const { statusData, typeData, priorityData } = useMemo(() => {
//         const statusData = Object.entries(TasksByStatus).map(([name, value]) => ({ name: name.replace("_", " "), value }));
...
//         }));
//         return { statusData, typeData, priorityData };
//     }, [TasksByStatus, TasksByType, TasksByPriority, TotalTasks]);
