    ...
    return (
        <div className="relative">
            <Link
                ...
                className="block bg-white dark:bg-zinc-950 dark:bg-gradient-to-br 
                           dark:from-zinc-800/70 dark:to-zinc-900/50 
            ...
            {/* Archive 按钮（只在非 Archived） */}
            {!isArchived && onArchive && (
                <button
                    onClick={() => onArchive(project.id)}
                    className="absolute top-2 right-2 p-1.5 rounded 
                               bg-red-500 hover:bg-red-600 
                               text-white text-xs flex items-center gap-1 z-10"
                >
