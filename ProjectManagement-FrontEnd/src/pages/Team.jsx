                ...
                <tbody className="divide-y divide-gray-200 dark:divide-zinc-800">
                  {filteredUsers.map((user) => (
                    <tr key={user.id}>
                      ...
                      {/* Email */}
                      <td className="px-6 py-2.5 whitespace-nowrap align-middle text-sm text-gray-500 dark:text-zinc-400">
                        {user.user.email}
                      </td>
                      ...
                      <td className="px-6 py-2.5 whitespace-nowrap align-middle">
                        <div className="flex items-center justify-between">
                          <span
                            className={`px-2 py-1 text-xs rounded-md ${user.role === "LEADER"
