...
//     try {
//       // Task 详情
//       const tsk = await getTaskDetailsById(taskId);
//       if (!tsk) {
//         setTask(null);
//         setLoading(false);
//         return;
...
//       setTask({
//         ...tsk,
//         assignee: { name: tsk.assigneeName, image: tsk.assigneeImage || assets.profile_img_a },
//         due_date: tsk.dueDate,
//       });

//       // Project 详情
//       const projRes = await API.get(`/projects/${tsk.projectId}/update/form`);
//       const proj = projRes.data;
//       setProject({
//         id: proj.id,
//         name: proj.title,
//         start_date: proj.startDate || new Date(),
//         status: proj.status,
//         priority: proj.priority || "N/A",
//         progress:
//           proj.totalTasks > 0
//             ? Math.floor((proj.completedTasks / proj.totalTasks) * 100)
//             : 0,
//       });

//       setLoading(false);
//     } catch (error) {
//       console.error("Failed to fetch task/project details", error);
//       toast.error("Failed to fetch task or project details");
//       setLoading(false);
//     }
//   };
...
//           <div className="p-4 rounded-md bg-white dark:bg-zinc-900 text-zinc-700 dark:text-zinc-200 border border-gray-300 dark:border-zinc-800">
//             <p className="text-xl font-medium mb-4">Project Details</p>
//             <h2 className="text-gray-900 dark:text-zinc-100">{project.name}</h2>
